...
DROP TABLE IF EXISTS `ent_all_configs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `file_extra`
--
...
CREATE TABLE `file_extra` (
  ...
  `type` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'file',
  `size` int(11) NOT NULL DEFAULT '0',
  `upload_time` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  `expire_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  KEY `idx_ent` (`ent_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `file_extra`
--

LOCK TABLES `file_extra` WRITE;
/*!40000 ALTER TABLE `file_extra` DISABLE KEYS */;
/*!40000 ALTER TABLE `file_extra` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `message` VALUES ('bi5o61f3mj06aiqprtqg','1234','5678','wowowo890','x1234y123z','agent','text','2019-03-15 18:48:37.070701',NULL,'Hello everyone','system',NULL);
...
DROP TABLE IF EXISTS `promotion_msgs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
INSERT INTO `quickreply_group` VALUES ('bh1vldt5jj85k57df81g','bgrg80l5jj83bqe154fg','this is a test group',0,'bgrg80l5jj83bqe154h0','',0,'2019-01-20 12:36:07.330720','2019-03-08 21:36:43.441080'),('bh1vm7t5jj85koc4s86g','bgrg80l5jj83bqe154fg','this is a test group',1000,'bgrg80l5jj83bqe154h0','',0,'2019-01-20 12:37:51.949737','2019-03-08 21:36:43.441080'),('bh1vm9d5jj85koc4s870','bgrg80l5jj83bqe154fg','this is a test group111',1000,'bgrg80l5jj83bqe154h0','',0,'2019-01-20 12:37:57.638688','2019-03-08 21:36:43.441080');
...
INSERT INTO `visitor_tag` VALUES ('bgrgh9t5jj83bqe15580','bgrg80l5jj83bqe154fg','bgrg80l5jj83bqe154h0','test tag update','浅蓝',0,0,'2019-01-10 16:56:07.364274','2019-01-10 17:00:40.680643');
...
-- Dump completed on 2019-04-03  6:34:18
